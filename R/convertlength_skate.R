...
#' "estimated" = only the estimate lengths with all other lengths as NA such that the
#' returned vector is the same length and the number of rows of the input data frame.
#'
#' @export
